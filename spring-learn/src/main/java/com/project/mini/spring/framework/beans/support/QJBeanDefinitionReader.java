 ...
 * @Description:
 * @Author: kejl
 * @Date: Created in 2:27 PM 2019/4/11
 **/
public class QJBeanDefinitionReader {
    private Properties config = new Properties();
    private final String SCAN_PACKAGE = "scanPackage";
    private List<String> registerBeanName;

    public QJBeanDefinitionReader(String... locations) {
    ...
    private  void doScanner(String scanPackage) {
        ...
        for(File file : classpath.listFiles()){
            if(file.isDirectory()){
                ...
                registerBeanName.add(className);
            }
        }
